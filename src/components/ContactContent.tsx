          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              {state.succeeded ? (
                <div className="bg-green-800/50 border border-green-500 rounded-lg p-6 text-center">
                  <p className="text-green-300 text-lg mb-2">{t('contact.thankYou')}</p>
                  <p className="text-green-200">{t('contact.thankYouSub')}</p>
                </div>
              ) : (
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-gray-300">{t('contact.connectIntro')}</p>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold mb-2">{t('contact.followMe')}</h3>
                ...
                <div className="mt-8 p-6 bg-gray-800 rounded-lg">
                  <h3 className="text-lg font-semibold mb-4">{t('contact.quickResponseTitle')}</h3>
                  <p className="text-gray-300 mb-4">{t('contact.quickResponseText')}</p>
                  <Link
